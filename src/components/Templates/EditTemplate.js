...
const EditTemplate = ({ itemType, fieldsArray, }) => {
    ...
    return (
        <Box m={4}>
            {
                campaign.status
                    ? <AddForm fields={!!submission ? submission : campaign} fieldsArray={fieldsArray} handleFormCompletion={handleSubmision} schema={campaignSchema} />
